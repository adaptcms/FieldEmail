...
class FieldEmailServiceProvider extends ServiceProvider
{
  /**
  ...
  {
    $this->mergeConfigFrom(__DIR__.'/../config/fieldemail.php', 'fieldemail');

    // Register the service the package provides.
    $this->app->singleton('FieldEmail', function ($app) {
  ...
  protected function bootForConsole()
  {
    ...
    $this->publishes([
        __DIR__.'/../config/fieldemail.php' => config_path('fieldemail.php'),
    ], 'fieldemail.config');
    ...
    foreach (glob(__DIR__ . '/Console/Commands/*.php') as $row) {
      // init class path
      $classPath = '\\Adaptcms\\FieldEmail\\Console\\Commands\\';
